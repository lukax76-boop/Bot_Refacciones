...
async function processMessageLogic(phone, text, senderName) {
    ...
    // (Comando de ayuda desactivado a petición del usuario para ocultar la funcionalidad de ayuda por completo)
    /*
